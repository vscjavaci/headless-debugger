...
public class ProtocolServer {
     ...
     *              the output writer
     */
    public ProtocolServer(Reader reader, Writer writer, IDebugAdapter adatper) {
        this.reader = reader;
        this.writer = writer;
        this.bodyLength = -1;
        ...
        this.debugAdapter = adatper == null ? new DebugAdapter(null) : adatper;
        this.debugAdapter.setConsumer(debugEvent -> {
